...
import UndoableEditor from './UndoableEditor';
import { copyToClipBoard, deepEqual, isDeepEqual, print } from '../pages/utils';
...
class SpeechToText extends React.Component {
    ...
    render() {
        ...
        return (<>
            ...
            <div className={'flex relative flex-wrap gap-0 w-full mt-1 ' + (this.state.isActive?'z-4':'')}>
            {this.props.textArea != false && <div className='flex w-full h-full'>
                ...
                { this.props.disabled != true && <div className='scalein animation-duration-500 animation-iteration-1 animation-ease-out flex m-0 h-1 w-full align-content-between p-inputgroup'>
